...
Fence::Fence(DX12Renderer* renderer, XMFLOAT3 p1, XMFLOAT3 p2, XMFLOAT3 p3, XMFLOAT3 p4) {
	...
	m_dx12vertexBuffer = std::make_unique<DX12VertexBuffer>((size_t)(nrVertices * sizeof(Vertex)), VertexBuffer::DATA_USAGE::DYNAMIC, renderer);
	...
	m_mesh->setIABinding(m_dx12vertexBuffer.get(), m_indexBuffer.get(), 0, nrVertices, nrIndices, sizeof(Vertex));
